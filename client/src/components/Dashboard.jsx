      ...
      <motion.div variants={fadeSlideUp} className="mb-6 md:mb-10">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 sm:gap-4">
          <div className="min-w-0">
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-surface-900 break-words">
      ...
      <motion.div variants={fadeSlideUp} className="mb-6 md:mb-8 w-full max-w-md">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 md:py-3 bg-surface-100 border border-surface-200 rounded-xl md:rounded-2xl text-sm text-surface-900 placeholder-surface-500 outline-none focus:border-brand-500/40 focus:ring-2 focus:ring-brand-500/10 transition-all duration-200"
          />
        </div>
      </motion.div>
